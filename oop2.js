...
$(function() {
    ...
    function Button(text) { //krok 1 - uzupełnienie konstruktora o parametr text, za pomocą którego ustawimy początkową wartość dla text w nowych obiektach.
        this.text = text || "Hello"; //krok 2 - Dodajmy możliwość tworzenia obiektu bez podania argumentu. Domyślną wartością właściwości text naszych przycis ków będzie ‘Hello’.
    }
